...
//This is the ActionListener class for decreasing the escape time distance by .01.
public class ActionListenerEscapeDistanceDecreaseSmall implements ActionListener {
	JButton jb;
	Main m;
	UI ui;
	...
	public ActionListenerEscapeDistanceDecreaseSmall(UI _ui, JButton _jb, Main _m) {
		m = _m;
		ui = _ui;
		jb = _jb;
	...
	public void actionPerformed(ActionEvent e) {
		if (jb.isEnabled() && !(m.distanceVal < 0)) {
			ui.updateImageDecreaseSmall();
			if (m.distanceVal < 0) {
				ui.updateImageIncreaseSmall();
			}
		}
