...
//This is the ActionListener class for increase the escape time distance by .01 .
public class ActionListenerEscapeDistanceIncreaseSmall implements ActionListener {
	JButton jb;
	Main m;
	UI ui;
	...
	public ActionListenerEscapeDistanceIncreaseSmall(UI _ui, JButton _jb, Main _m) {
		m = _m;
		ui = _ui;
		jb = _jb;
	}
