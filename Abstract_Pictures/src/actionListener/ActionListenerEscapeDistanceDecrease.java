...
// This is the ActionListener class for decreasing the escape time distance by .1.
public class ActionListenerEscapeDistanceDecrease implements ActionListener {
	JButton jb;
	Main m;
	UI ui;
	...
	public ActionListenerEscapeDistanceDecrease(UI _ui, JButton _jb, Main _m) {
		m = _m;
		ui = _ui;
		jb = _jb;
